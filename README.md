...
- These notes repository are available in power-point, google slides and pdf. The master file is always the google slide, which means that in some rare occasion the others may not be up-to-date. If you want to modify the file, just download locally and upload them on your Google Drive or wherever you prefer. 
...
## MLOPs
[[pptx | Google Slide | pdf]](https://drive.google.com/drive/folders/1aMJVxgq305W9w1Lcd_5pH-tEBOl6Y1Ua?usp=sharing)
***
